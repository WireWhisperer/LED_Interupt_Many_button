...
;;====================================================================
# 1 "D:\\PIC\\xc8\\v4.00\\pic\\include/xc.inc" 1 3
...
# 1 "D:/PIC/MPLABX/v6.35/packs/Microchip/PIC16F1xxxx_DFP/1.31.465/xc8\\pic\\include/pic.inc" 1 3



# 1 "D:/PIC/MPLABX/v6.35/packs/Microchip/PIC16F1xxxx_DFP/1.31.465/xc8\\pic\\include/pic_as_chip_select.inc" 1 3
# 635 "D:/PIC/MPLABX/v6.35/packs/Microchip/PIC16F1xxxx_DFP/1.31.465/xc8\\pic\\include/pic_as_chip_select.inc" 3
# 1 "D:/PIC/MPLABX/v6.35/packs/Microchip/PIC16F1xxxx_DFP/1.31.465/xc8\\pic\\include\\proc/pic16f18854.inc" 1 3
# 33 "D:/PIC/MPLABX/v6.35/packs/Microchip/PIC16F1xxxx_DFP/1.31.465/xc8\\pic\\include\\proc/pic16f18854.inc" 3
INDF0 equ 0000h
...
# 25853 "D:/PIC/MPLABX/v6.35/packs/Microchip/PIC16F1xxxx_DFP/1.31.465/xc8\\pic\\include\\proc/pic16f18854.inc" 3
...
# 636 "D:/PIC/MPLABX/v6.35/packs/Microchip/PIC16F1xxxx_DFP/1.31.465/xc8\\pic\\include/pic_as_chip_select.inc" 2 3
# 5 "D:/PIC/MPLABX/v6.35/packs/Microchip/PIC16F1xxxx_DFP/1.31.465/xc8\\pic\\include/pic.inc" 2 3
...
auto_size SET 0
ENDM
# 8 "D:\\PIC\\xc8\\v4.00\\pic\\include/xc.inc" 2 3
# 9 "helloworld.s" 2
...
intentry:
    ...
    ;--- 判断中断源 2：定时器 TMR0 溢出 (PIR0 bit5 / ((PIR0) and 07Fh), 5) ---
    TMR0_OP:
    BANKSEL PIR0
    BTFSS PIR0, PIR0_TMR0IF_POSN ;((PIR0) and 07Fh), 5=1 是 TMR0 中断；否则非本程序中断，直接返回
    RETFIE
...
_main:
    ...
    BANKSEL T0CON1
    movlw 0b01000000
    movwf T0CON1 ;T0CS=010(FOSC/4), ((T0CON1) and 07Fh), 4, T0CKPS=0000(1:1) → 定时基准
    ...
    BANKSEL PIE0
    CLRF PIE0
    bsf PIE0, PIE0_TMR0IE_POSN ;((PIE0) and 07Fh), 5 使能
    ...
    CLRF PIR0 ;清所有中断标志
    BANKSEL INTCON
    bsf INTCON, INTCON_PEIE_POSN ;((INTCON) and 07Fh), 6 Enable 外设中断使能
    bsf INTCON, INTCON_GIE_POSN ;((INTCON) and 07Fh), 7 Enable 全局中断使能
...
; p1=((PORTC) and 07Fh), 0, p2=((PORTC) and 07Fh), 1, p3=((PORTC) and 07Fh), 2, p4=((PORTC) and 07Fh), 3
